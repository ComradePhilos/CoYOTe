...
begin
  ...
  EditSettingsForm.CheckBox1.Checked := openLatestFile;
end;
...
begin
  ...
  // Recent Files
  INI.WriteString('RecentFiles', 'open_latest', BoolToStr(openLatestFile));
...
begin
  ...
  openLatestFile := StrToBool(INI.ReadString('RecentFiles', 'open_Latest', BoolToStr(openLatestFile)));
