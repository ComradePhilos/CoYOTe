...
// sorry for any german comments in the code, I may have mixed it sometimes ;)
...
type
  ...
  private
    ...
    procedure GetDatabaseConnection(Sender: TObject; AIBConnection: TIBConnection);
...
procedure TForm1.GetDatabaseConnection(Sender: TObject; AIBConnection: TIBConnection);
begin
  //IBConnection1.Assign(AIBConnection);
  StatusBar1.Panels[0].Text := 'Datenbank verbunden!';
end;
