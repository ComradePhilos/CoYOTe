...
//############################################ Period ###########################################################
  ...
  public
    ...
    function getDayOfLatestQuitting: TDate;   // Returns the Date of the latest qutting
    function getDayOfEarliestBegin: TDate;    // Returns the Date of the earliest begin
...
function TWorkWeek.getDayOfEarliestBegin: TDate;
begin

end;

function TWorkWeek.getDayOfLatestQuitting: TDate;
begin
